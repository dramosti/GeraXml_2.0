...
namespace HLP.WebService.SCAN_Producao_Nfe_StatusServico {
    ...
    public partial class NfeStatusServico : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public NfeStatusServico() {
            this.Url = global::HLP.WebService.Properties.Settings.Default.HLP_WebService_SCAN_Homologacao_Nfe_Status_NfeStatusServico;
