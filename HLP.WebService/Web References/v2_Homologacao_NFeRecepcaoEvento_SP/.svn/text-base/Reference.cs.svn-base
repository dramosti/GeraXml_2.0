...
namespace HLP.WebService.v2_Homologacao_NFeRecepcaoEvento_SP {
    using System;
    ...
    public partial class RecepcaoEvento : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public RecepcaoEvento() {
            ...
            this.Url = global::HLP.WebService.Properties.Settings.Default.HLP_WebService_v2_Homologacao_NFeRecepcaoEvento_RecepcaoEvento;
