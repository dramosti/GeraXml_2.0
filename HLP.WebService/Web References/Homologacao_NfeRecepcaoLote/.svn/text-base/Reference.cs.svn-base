...
namespace HLP.WebService.Homologacao_NfeRecepcaoLote {
    ...
    public partial class NfeRecepcao : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public NfeRecepcao() {
            this.Url = global::HLP.WebService.Properties.Settings.Default.HLP_WebService_Homologacao_NfeRecepcaoLote_NfeRecepcao;
