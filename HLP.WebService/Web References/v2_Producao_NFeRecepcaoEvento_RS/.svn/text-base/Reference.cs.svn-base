...
namespace HLP.WebService.v2_Producao_NFeRecepcaoEvento_RS {
    using System;
    ...
    public partial class RecepcaoEvento : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public RecepcaoEvento() {
            ...
            this.Url = global::HLP.WebService.Properties.Settings.Default.HLP_WebService_v2_Producao_NFeRecepcaoEvento_RS_RecepcaoEvento;
