...
namespace HLP.WebService.Producao_NFeRecepcao {
    ...
    public partial class NfeRecepcao : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public NfeRecepcao() {
            this.Url = global::HLP.WebService.Properties.Settings.Default.HLP_WebService_Producao_NFeRecepcao_NfeRecepcao;
