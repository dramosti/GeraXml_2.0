...
namespace HLP.bel
{
    public class belNfeConsultaNF
    {
        ...
        /// <summary>
        /// Caminho da Pasta de XMLSchemas.
        /// </summary>
        private string _pathschemas;
        /// <summary>
        /// Versão do Cabeçalho.
        /// </summary>
        ...
        public belNfeConsultaNF(string sVersao, string sVerDados, int iTpamb, string sChnfe, string sXServ)
        {
            Globais Gb = new Globais();
            _tpamb = iTpamb;
            _pathschemas = Gb.LeRegConfig("PastaSchema").ToString();
            _versao = sVersao;
            _versaodados = sVerDados;
            _xserv = sXServ;
            _chnfe = sChnfe;
        ...
        private string consultaNFe()
        {
            ...
            try
            {
                ...
                myschema.Add("http://www.portalfiscal.inf.br/nfe", _pathschemas + "\\consSitNFe_v2.00.xsd");
