                    ...
                    case "ICMS60":
                        {
                            ...
                            objIcms60.Vbcst = Convert.ToDecimal(xIcmsN.GetElementsByTagName("vBCST")[0].InnerText);
                            objIcms60.Vicmsst = Convert.ToDecimal(xIcmsN.GetElementsByTagName("vICMSST")[0].InnerText);
