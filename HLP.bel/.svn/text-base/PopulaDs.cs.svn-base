    ...
    {        
        ...
        private Byte[] carregaImagem(string fileName)
        {
            ...
            catch (Exception ex)
            {
                ...
                //MessageBox.Show(null,"Caminho do logotipo não encontrado ou arquivo não encontrado! " + ex.Message,"ERRO DE IMPRESSÃO DE DANFE", MessageBoxButtons.OK, MessageBoxIcon.Error);
