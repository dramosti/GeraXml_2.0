                ...
                for (int i = 0; i < xDoc.GetElementsByTagName("det").Count; i++)
                {
                    ...
                    if (xDoc.GetElementsByTagName("det").Count > 0)
                    {
                        ...
                        if (xDet.GetElementsByTagName("prod").Count > 0)
                        {
                            ...
                            {
                                objProd.Ucom = xProd.GetElementsByTagName("uCom")[0].InnerText.Substring(0, 2).ToString();
                            }
                    ...
                    case "ICMS60":
                        {
                            ...
                            for (int i = 0; i < xIcmsN.ChildNodes[0].ChildNodes.Count; i++)
                            {
                                switch (xIcmsN.ChildNodes[0].ChildNodes[i].Name)
                                {
                                    ...
                                    case "vBCST":
                                        {
                                            objIcms60.Vbcst = Convert.ToDecimal(xIcmsN.GetElementsByTagName("vBCST")[0].InnerText.ToString().Replace(".", ","));
                                        }
                                        break;
                                    case "vICMSST":
                                        {
                                            objIcms60.Vicmsst = Convert.ToDecimal(xIcmsN.GetElementsByTagName("vICMSST")[0].InnerText.ToString().Replace(".", ","));
                                        }
                                        break;
                                }
                            }
                        ...
                        case "IPITrib":
                            {
                                ...
                                {
                                    objIpiTrib.Qunid = xIpiN.GetElementsByTagName("qUnid")[0].InnerText;
                                }
