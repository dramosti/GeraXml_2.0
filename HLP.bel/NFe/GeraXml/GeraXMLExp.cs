    ...
    public class GeraXMLExp
    {
        ...
        public void NFe(string sEmp, List<string> sNF, string sNomeArq, string sFormaEmissao, string sForDanfe, string cd_ufnro, X509Certificate2 cert, bool bModoSCAN, int iSerieSCAN, string sFormaEmiNFe, Version versao)
        {
            ...
            try
            {
                foreach (string sNota in sNF)
                {
                    ...
                    if (belStatic.sNomeEmpresa.Equals("ZINCOBRIL")) // OS_25787
                    {
                                ...
                                string sNF)
        {
            ...
            try
            {
                ...
                sSql.Append(fExisteCampo("TP_LOGRADOURO", "CLIFOR") ? "clifor.TP_LOGRADOURO tpLgr, " : "'' tpLgr, ");
                ...
                //Conn.Open();
                FbCommand cmdDest = new FbCommand(sSql.ToString(), cx.get_Conexao());
                ...
                {
                    tpLgr = drDest["tpLgr"].ToString();
                }
                if (drDest["xlgr"].ToString() != "")
                {
                    objdest.Xlgr = (String.IsNullOrEmpty(tpLgr) ? "" : tpLgr + " ") + belUtil.TiraSimbolo(drDest["xlgr"].ToString(), "");
                }
                ...
                {
                    objdest.Ie = drDest["IE"].ToString();//  belUtil.TiraSimbolo(drDest["IE"].ToString(), "");
                }
                else
                {
                    if (drDest["st_pessoaj"].ToString() != "S")
                                        ...
                                        string sNF)
        {
            ...
            try
            {
                ...
                FbCommand cmdEndent = new FbCommand(sSql.ToString(), cx.get_Conexao());
                                    ...
                                    string sCdNfseq)
        {
            ...
            try
            {
                ...
                FbCommand cmdEmit = new FbCommand(sSql.ToString(), cx.get_Conexao());
                cx.Open_Conexao();
                                    ...
                                    Version versao)
        {
            ...
            try
            {
                ...
                drIde.Read();
                string sNFe = "NFe" + GeraChave(sEmp, sNF);
                objide = new belIde();
                                   ...
                                   string sNF, belDest objdest)
        {
            ...
            bool bAgrupaCampos = VerificaSeAgrupaItens(cx.get_Conexao());
            ...
            try
            {
                ...
                if (belUtil.CampoExisteNaTabela("DS_DETALHE", "PRODUTO"))
                {
                    lCampos.Add(new CamposSelect { sCampo = "coalesce(PRODUTO.DS_DETALHE,'')", sAlias = "DS_DETALHE" });//OS_27561                   
                }
                else
                {
                    lCampos.Add(new CamposSelect { sCampo = "''DS_DETALHE", sAlias = "DS_DETALHE" });//OS_27561   
                }
                ...
                if (belStatic.sNomeEmpresa != "MOGPLAST")
                {
                ...
                if (belStatic.sNomeEmpresa != "NAVE_THERM")
                {
                ...
                if (belStatic.sNomeEmpresa.Equals("MAD_STA_RITA"))
                {
                ...
                if ((belStatic.sNomeEmpresa == "NAVE_THERM") || (belStatic.sNomeEmpresa == "MOGPLAST"))
                {
                ...
                string sql = "select max(nr_lanc) from movitem where (movitem.cd_empresa ='" +
                                                     ...
                                                     sNF +
                                                     "') ";
                using (FbCommand cmd = new FbCommand(sql, cx.get_Conexao()))
                {
                ...
                FbCommand cmdItem = new FbCommand(sQueryItens, cx.get_Conexao());
                ...
                while (drIItem.Read())
                {
                    ...
                    else if (belStatic.sNomeEmpresa == "CALDLASER")
                    {
                        ...
                        else
                        {
                            ...
                            {
                                objprod.Xprod = drIItem["xProd"].ToString().Trim() + " - " + drIItem["DS_DETALHE"].ToString().Trim();
                            }
                            else
                            {
                                objprod.Xprod = drIItem["xProd"].ToString().Trim();
                    ...
                    if (belStatic.sNomeEmpresa == "ESTACAHC") // Diego - OS_24595
                    {
                    ...
                    // }
                    pbIndustri = bIndustrializacao(drIItem["cd_operval"].ToString());

                    if (VerificaNotaComSuframa(sEmp, sNF)) //NFe_2.0
                    {
                    ...
                    if (vl_desconto == 0)
                    {
                        vl_desconto = BuscaDescTotal(sEmp, sNF, cx.get_Conexao());
                    }
                    ...
                    if (objdest.Uf.Equals("EX"))
                    {
                        ...
                        using (FbCommand cmd = new FbCommand(sQuery.ToString(), cx.get_Conexao()))
                        {
                            ...
                            while (dr.Read())
                            {
                                ...
                                using (FbCommand cmd2 = new FbCommand(sQuery.ToString(), cx.get_Conexao()))
                                {
                    ...
                    string sSimplesNac = VerificaEmpresaSimplesNac(sEmp, cx.get_Conexao()); // Diego - OS 24918 - 14/09/2010
                    decimal dvBC = 0;
                            ...
                            case "40":
                                {
                                    ...
                                    obj40.motDesICMS = (dvICMS > 0 ? (VerificaNotaComSuframa(sEmp, sNF) == false ? 9 : 7) : 0); // NFe_2.0
                    ...
                    if ((sTributaIPI == "49") || (sTributaIPI == "00") || (sTributaIPI == "50") || (sTributaIPI == "99"))
                    {
                        ...
                        if (drIItem["ST_SUPERSIMPLES"].ToString() == "N")
                        {
                            ...
                            if ((belStatic.sNomeEmpresa.Equals("EMBALATEC")) && (drIItem["st_ipi"].ToString().Equals("S")))//OS_25673
                            {
                    ...
                    if ((drIItem["st_piscofins"].ToString() == "S") && (Convert.ToInt16(sCst) <= 2))
                    {
                    ...
                    else if (Convert.ToInt16(sCst) > 9)
                    {
                        ...
                        sSimplesNac = VerificaEmpresaSimplesNac(sEmp, cx.get_Conexao());
                        belPisoutr objpisoutr = new belPisoutr();
                        objpisoutr.Cst = sCst;
                        decimal dvlBasepis = Math.Round(Convert.ToDecimal(drIItem["vl_basepis"].ToString()), 2);
                        objpisoutr.Vbc = (objpisoutr.Cst.ToString().Equals("99") ? 0 : dvlBasepis); //24872
                        decimal dpPis = Math.Round(Convert.ToDecimal(drIItem["vl_aliqpis_suframa"].ToString()), 2);
                        objpisoutr.Ppis = (objpisoutr.Cst.ToString().Equals("99") ? 0 : dpPis);
                        decimal dvPIS = Math.Round(Convert.ToDecimal(drIItem["vl_pis"].ToString()), 2);
                        dTotPis += dvPIS;
                        objpisoutr.Vpis = (objpisoutr.Cst.ToString().Equals("99") ? 0 : dvPIS);
                    ...
                    if ((drIItem["st_piscofins"].ToString() == "S") && (Convert.ToInt16(drIItem["cd_sittribcof"].ToString()) <= 2))
                    {
                    ...
                    string sObsItem = "";
                    if (belStatic.sNomeEmpresa == "HELENGE")
                    {
                        sObsItem += (BuscaContratoOBS(sEmp, drIItem["nr_lanc"].ToString(), cx.get_Conexao())).Replace(Environment.NewLine, "-");
                    }
                    if (belStatic.sNomeEmpresa == "FORMINGP")                    //Diego - O.S 24028 - 22/01/2010
                    {
                        sObsItem += BuscaSerieProd(sEmp, drIItem["nr_lanc"].ToString(), cx.get_Conexao());
                    }//Fim - Diego - O.S 24028 - 22/01/2010

                    if (belStatic.sNomeEmpresa == "JAMAICA")
                    {
                        sObsItem += BuscaInformacoesLote(drIItem["nr_lanc"].ToString(), cx.get_Conexao());
                    }
                    sObsItem = BuscaObsItemSimples(sEmp, drIItem["nr_lanc"].ToString(), cx.get_Conexao()) + sObsItem; //17/11/2010
                    ...
                    if (belStatic.sNomeEmpresa == "MARPA")
                    {
                        sObsItem = MontaObsItem(sEmp, drIItem["nr_lanc"].ToString(), cx.get_Conexao());
                        if (sObsItem != "")
                        {
                    ...
                    if (drIItem["nr_lanc"].ToString() == sNr_Lanc)
                    {
                        if (drIItem["xLgrRedes"].ToString().Trim() != "")
                        {
                            ...
                            sTransportadora = string.Format((belStatic.sNomeEmpresa == "TORCETEX" ? "FRETE A PAGAR DESTINO - TRANSP . DE REDESPACHO.: " : "Redespacho.:")
                    ...
                    if ((belStatic.sNomeEmpresa.Equals("TORCETEX")))
                    {
                                    ...
                                    string sNF, belDest objdest)
        {
            ...
            try
            {
                ...
                string sStImpICMS_Em_Subst_NF = BuscaSTICMSEMSUBSTNF(sEmp, sNF, cx.get_Conexao());
                ...
                bool bNfSuframa = VerificaNotaComSuframa(sEmp, sNF);
                ...
                sSql.Append(sNF);
                sSql.Append("') ");
                FbCommand cmdTotais = new FbCommand(sSql.ToString(), cx.get_Conexao());
                                    ...
                                    string sNF)
        {
            ...
            string snm_Cliente = belStatic.sNomeEmpresa;
            ...
            try
            {
                ...
                FbCommand cmdTranspor = new FbCommand(sSql.ToString(), cx.get_Conexao());
                cx.Open_Conexao();
                ...
                if (drTranspor.Read()) //Claudinei - o.s. 24210 - 03/03/2010
                {
                    ...
                    using (FbCommand cmd = new FbCommand(sSql2.ToString(), cx.get_Conexao()))
                    {
                        cx.Open_Conexao();
                        razao_transp = Convert.ToString(cmd.ExecuteScalar()).Trim();

                    }
                    if (drTranspor["modFrete"].ToString() == "0") // Remetnete(Emitente)
                    {
        ...
        private bool GravaNumeroChaveNota(string sEmp, string sNota, string sNFe)
        {
            StringBuilder sSql = new StringBuilder();
        ...
        public bool bIndustrializacao(string sOperacoesValidas)
        {
            ...
            using (FbCommand cmd = new FbCommand(sSql, cx.get_Conexao()))
            {
                cx.Open_Conexao();
        ...
        private decimal BuscaDescTotal(string sEmp, string sNF, FbConnection Conn)
        {
            ...
            else if (belStatic.sNomeEmpresa == "EMEB")
            {
                vl_Desconto = 0;
            }
            return vl_Desconto;
        ...
        /// <returns></returns>
        private bool VerificaNotaComSuframa(string sEmp, string sNF)
        {
            try
            {
                StringBuilder sQuery = new StringBuilder();
