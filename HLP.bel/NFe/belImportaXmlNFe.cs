                    ...
                    case "ICMS60":
                        {
                            ...
                            for (int i = 0; i < xIcmsN.ChildNodes[0].ChildNodes.Count; i++)
                            {
                                switch (xIcmsN.ChildNodes[0].ChildNodes[i].Name)
                                {
                                    ...
                                    case "vBCSTRet":
                                        {
                                            objIcms60.Vbcst = Convert.ToDecimal(xIcmsN.GetElementsByTagName("vBCSTRet")[0].InnerText.ToString().Replace(".", ","));
                                        }
                                        break;
                                    case "vICMSSTRet":
                                        {
                                            objIcms60.Vicmsst = Convert.ToDecimal(xIcmsN.GetElementsByTagName("vICMSSTRet")[0].InnerText.ToString().Replace(".", ","));
                                        }
                                        break;
                                }
                            }
