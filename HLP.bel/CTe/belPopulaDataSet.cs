    ...
    public class belPopulaDataSet
    {
        ...
        public void PopulaDataSet(dsCTe dsCte, string sCaminho, int iChave, string sProtocolo)
        {
            try
            {
                ...
                Byte[] bLogo = carregaImagem(objGlobais.LeRegWin("Logotipo"));
               ...
               string scCT = dsIde.cCT; //sicupira
                ...
                if (objcont.Count > 0)
                {
                    ...
                    dsObsCont.xTexto += Environment.NewLine + BuscaNumNotas(scCT);
                ...
                {
                    dsObsCont = dsCte.ObsCont.NewObsContRow();
                    dsObsCont.xTexto = BuscaNumNotas(scCT);
                    dsObsCont.pk_compl = iChave;
                    dsObsCont.pk_xObs = iChave;
                    dsCte.ObsCont.AddObsContRow(dsObsCont);
                }
        ...
        {
            DirectoryInfo dBarras = new DirectoryInfo(belStaticPastas.CBARRAS);
