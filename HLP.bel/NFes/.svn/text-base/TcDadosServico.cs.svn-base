...
namespace HLP.bel.NFes
{
    ...
    public class TcDadosServico
    {
        ...
        public string ItemListaServico
        {
            ...
            set { _itemListaServico = Util.Util.ValidaTamanhoMaximo(5, value); }
        }
        /// <summary>
        /// </summary>
        ...
        public string CodigoTributacaoMunicipio
        {
            ...
            set { _codigoTributacaoMunicipio = Util.Util.ValidaTamanhoMaximo(20, value); }
        }
        /// <summary>
        /// </summary>
        ...
        public string Discriminacao
        {
            ...
            set { _discriminacao = Util.Util.ValidaTamanhoMaximo(2000, value); }
        }
