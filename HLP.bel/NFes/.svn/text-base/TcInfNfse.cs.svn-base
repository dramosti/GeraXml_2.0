...
namespace HLP.bel.NFes
{
    ...
    public class TcInfNfse
    {
        ...
        {
            get { return _id; }
            set { _id = Util.Util.ValidaTamanhoMaximo(225, value); }
        }
        ...
        public string CodigoVerificacao
        {
            ...
            set { _codigoVerificacao = Util.Util.ValidaTamanhoMaximo(9, value); }
        }
        ...
        public string OutrasInformacoes
        {
            ...
            set { _outrasInformacoes = Util.Util.ValidaTamanhoMaximo(225, value); }
        }
